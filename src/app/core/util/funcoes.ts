import { PaginaEnum, TipoArquivoEnum } from "./constantes";
...
export class Funcoes{ 
    ...
    ***************************************************************************************************/
   public static dateToString(data: string): any {
        if (!data || data.length == 0) {
            return '';
        }
    ...
    ***************************************************************************************************/
    public static openFile(nome, binario, extensao): void {
        let tipoArquivo = TipoArquivoEnum.get(extensao.toUpperCase());
        let a = document.createElement('a');
        a.href = URL.createObjectURL(Funcoes.stringToBlob(binario, tipoArquivo.contentType));
        a.download = nome;
        a.click();
    }
